    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div class="lg:col-span-6 space-y-4">
        ...
        <div>
          ...
          <input type="range" id="smh-daily-scans" aria-label="Average Daily Scans / Patient Volume" min="4" max="60" value="${current.defaultDailyScans}" class="custom-range" oninput="updateSmhCalculations()">
        ...
        <div>
          ...
          <input type="range" id="smh-scan-fee" aria-label="Patient Fee per Diagnostic Scan (EGP)" min="100" max="3000" step="50" value="${current.scanPrice}" class="custom-range" oninput="updateSmhCalculations()">
          <div class="flex justify-between text-[10px] text-slate-500 font-mono mt-1">
            <span>100 EGP</span>
            <span>1,500 EGP</span>
            <span>3,000 EGP</span>
